...
/**
 * This does not use a {@link ProgressState},
 * because the child range for these methods is always in the range
 * [0, parentRange].
 *
 * @author Groboclown
 */
public interface ParentProgressController extends ProgressController {
