 ...
 * @author Groboclown
 */
public interface CategoryListResourceReader
        extends HostedResourceConsumer<GameDescriptionListResourceReader>,
            NamedResourceConsumer<GameDescriptionListResourceReader> {


    /**
     *
     * @return null if comment submission is not supported, or the submission
     *      instance if it is.
     */
