...
/**
 * Loads the applets in the source URL.  It does not visit other pages.
 *
 * @author Groboclown
 */
public class AppletUrlGameDescriptionListResourceReader
        extends AbstractHostedResourceConsumer<GameDescription>
        implements GameDescriptionListResourceReader {
    public AppletUrlGameDescriptionListResourceReader(String name) {
        this(name, null);
    }

    public AppletUrlGameDescriptionListResourceReader(String name, Resource r) {
        super(name, r);
    }
    ...
    public void processLoadedResource(Resource r,
        ...
        // There's nothing to really process here.  All the data is in the
        // details.

        DefaultGameDescription desc = new DefaultGameDescription();
        desc.setName(r.getURI().toString());
        desc.setDetailSource(r);
